<script type="text/javascript">
    $(document).ready(function () {
        $("#kembali").click(function () {
            Pace.restart();
            Pace.track(function () {
                window.location.href = base_url + "User/general";
            });
        });
    });
</script>
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            <a class="btn btn-block btn-social btn-info" id="kembali">
                ...
                <div class="box-body table-responsive">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td rowspan="3"
                                    style="text-align: center;white-space: nowrap;width: 1%;vertical-align: middle">
                                    <strong>No</strong></td>
                                <td rowspan="3" style="vertical-align: middle;text-align: center">
                                    <strong>Kegiatan</strong></td>
                                <td rowspan="3" style="text-align: center;vertical-align: middle"><strong>PPTK</strong>
                                </td>
                                <td colspan="4" style="text-align: center;white-space: nowrap;width: 1%"><strong>Keuangan</strong>
                                </td>
                                <td colspan="2" style="text-align: center;white-space: nowrap;width: 1%">
                                    <strong>Fisik</strong></td>
                                <td rowspan="3"
                                    style="text-align: center;white-space: nowrap;width: 1%;vertical-align: middle">
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align: center;white-space: nowrap;width: 1%"><strong>Realisasi</strong>
                                </td>
                                <td rowspan="2"
                                    style="text-align: center;white-space: nowrap;width: 1%;vertical-align: middle">
                                    <strong>Target</strong></td>
                                ...
                                if ($keg['idpnspptk'] == $pptk['nip']) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle"
                                            id="keg<?php echo $keg['kdkegunit'] ?>"><?php echo '<strong>' . $keg['nmkegunit'] . '</strong>'; ?></td>
