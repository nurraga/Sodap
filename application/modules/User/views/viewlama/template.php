...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/components/jquery-filestyle-2.1.0/src/jquery-filestyle.min.css') ?>" />
...
<script src="<?php echo base_url('assets/components/jquery-filestyle-2.1.0/src/jquery-filestyle.min.js') ?>"></script>

<!-- TinyMCE -->
<script src="<?php echo base_url('assets/components/tinymce/tinymce.js') ?>"></script>
