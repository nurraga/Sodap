            ...
            <div class="row">
                                    ...
                                    <!-- <div class="dropdown pull-left">
                                                <button  type="button" class="btn btn-round btn-info dropdown-toggle"  data-toggle="dropdown"  aria-expanded="false">
                                                            <i class="fa fa-external-default"></i>Tahun
                                                            <span class="caret"></span>
                                          <div class="ripple-container"></div></button>
                                                        <ul class="dropdown-menu dropdown-menu-left " role="menu">
                                                            <li>
                                                                <a href="<?php echo base_url('Kasubag/tahun2017');?>">Januari</a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo base_url('#');?>">2019</a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo base_url('#');?>">2020</a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo base_url('#');?>">2021</a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo base_url('#');?>">2022</a>
                                                            </li>
                                                            <li class="divider"></li>
						 ...
						 <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <span class="text-red"><?php echo form_error('analisis'); ?></span>
                                        </div>
                                    </div>
                         </div>
